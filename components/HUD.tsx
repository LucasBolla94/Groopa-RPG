...
const HUD: React.FC<Props> = ({ stats }) => {
  ...
  return (
    <div className="absolute top-4 left-4 w-64 bg-black/90 p-4 border-2 border-slate-600 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.8)] backdrop-blur-2xl pointer-events-none space-y-3">
      {/* HP BAR */}
      <div className="space-y-1.5">
        ...
        <div className="h-5 bg-red-950/40 rounded-md overflow-hidden border border-red-900/50 relative shadow-inner">
      ...
      <div className="space-y-1.5">
        ...
        <div className="h-5 bg-blue-950/40 rounded-md overflow-hidden border border-blue-900/50 relative shadow-inner">
